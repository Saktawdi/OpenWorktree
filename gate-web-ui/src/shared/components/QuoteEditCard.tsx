  ...
  return (
    <div className="quote-edit-card">
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-[11px] font-medium text-dim">编辑引用原文</span>
        <span className="text-[10.5px] text-faint truncate max-w-[300px]">
          {quotePreview(initialText, 28)}
        </span>
        <span className="flex-1" />
        <span className="font-mono text-[10.5px] text-faint">{text.length} 字</span>
        <button
          type="button"
      ...
      <div className="flex items-center gap-2">
        <span className="flex-1 text-[10.5px] text-faint">Ctrl+Enter 保存 · Esc 取消 · 清空后保存即移除胶囊</span>
        <button
          type="button"
