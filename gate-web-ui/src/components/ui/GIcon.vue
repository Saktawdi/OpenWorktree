...
/**
 * GIcon — 统一图标组件 (内联 SVG, 24x24, stroke 风格).
 * 图标来源: Lucide 风格路径, 集中管理便于后续替换为 appicon-forge 下载资产.
 */
withDefaults(
  defineProps<{
    name: GIconName;
...
const paths: Record<string, string> = {
  ...
  'git-branch': '<circle cx="6" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="6" r="3"/><path d="M6 9v6M18 9c0 4-4 4-6 4"/>',
