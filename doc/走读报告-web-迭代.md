...
> 走读对象：`doc/执行文档-后端-web.md`、`doc/执行文档-前端-web.md`、`doc/x.md`、`doc/讨论-DSH底座.md`（并参照 `doc/README.md` 索引核对关系）。
> 背景：闸门层 P0–P4 已全绿（94 tests green，A1–A12 通过）并归档至 `doc/归档/done/`；本迭代为 Web 操作台 + agent 会话编排（S0–S5、验收 A13–A19、ADR-10..14）。
...
5. **文档台账**：本轮定案后更新 `doc/README.md` 索引（新增本迭代条目）；讨论-DSH底座 v2 定案后归档为「评估记录 + 否决记录」。
